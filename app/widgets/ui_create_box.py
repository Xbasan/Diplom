...
class Ui_Create_cart(object):
    def setupUi(self, Create_cart):
        ...
        self.pushButton.setGeometry(QRect(350, 220, 61, 51))
        font1 = QFont()
        ...
        self.File_path.setGeometry(QRect(80, 220, 271, 51))
        ...
        self.saveButton.setGeometry(QRect(170, 340, 141, 61))
        font2 = QFont()
    ...
    def retranslateUi(self, Create_cart):
        ...
        self.pushButton.setToolTip(QCoreApplication.translate("Create_cart", u"<html><head/><body><p><span style=\" color:#000000;\">\u0412\u044b\u0431\u043e\u0440 \u0444\u0430\u0439\u043b\u0430</span></p></body></html>", None))
